...
final class Version20220303183215 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE asso_species (user_id INT NOT NULL, species_id INT NOT NULL, INDEX IDX_85236B12A76ED395 (user_id), INDEX IDX_85236B12B2A1D860 (species_id), PRIMARY KEY(user_id, species_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
